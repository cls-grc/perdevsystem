...
export default function SocialRecognition() {
  return (
    <WorkflowPage
      ...
      stages={[
        ["Submit nomination", "Share a recognition nomination.", ["employee", "hr", "supervisor"]],
        ["Supervisor validation", "Verify the achievement and nomination.", ["supervisor"]],
        ["HR review", "Approve or return the nomination.", ["hr"]]
      ]}
